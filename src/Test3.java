...
public class Test3 extends BaseDao{
    ...
    private static boolean loainUser() {
    	...
    	//1.加载驱动
    	   ...
    	   conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/easybuy?useUnicode=true&characterEncoding=utf-8","root","");
    	// 书写sql 现在dbms中运行一次
    	String sql = "SELECT loainName,password FROM easybuy_user where loainName='"
					+ loainName + "' and password='" + password + "'";
    	// 执行sql
    ...
    private static void updateUser() {
    	...
    	//1.加载驱动
    	   ...
    	   conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/easybuy?useUnicode=true&characterEncoding=utf-8","root","");
    	// 书写sql 现在dbms中运行一次
    	String sql = "UPDATE  easybuy_user SET loainName='" + loainName
    ...
    private static void insertUser() {
    	...
    	//1.加载驱动
    	   ...
    	   conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/easybuy?useUnicode=true&characterEncoding=utf-8","root","");
    	// 书写sql 现在dbms中运行一次
    	String sql = "INSERT  INTO easybuy_user(loainName,userName,`password`,sex)"
    					+ " VALUES('"
    					+ loainName
    					+ "','"
    					+ userName
